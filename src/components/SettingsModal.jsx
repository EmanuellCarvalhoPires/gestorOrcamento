...
export default function SettingsModal({ isOpen, onClose, onExportCSV, onExportPDF }) {
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                <div>
                  ...
                  <p style={{ margin: '6px 0 0 0', color: '#cccccc', fontSize: '13px' }}>
                    Escolha o formato desejado para exportar os lançamentos e relatórios da sua conta ativa.
                  </p>
                </div>
                    ...
                    <div>
                      ...
                      <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
                        ...
                        <input
                          ...
                          onChange={(e) => atualizarSaldoInicialCaixinha(e.target.value)}
                          style={{
                            padding: '8px 14px',
                            borderRadius: '10px',
